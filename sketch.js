...
function preload(){
  ...
  dancingTrex = loadAnimation("assets/win.jpeg");
...
function setup() {
  ...
  //trex.addAnimation("happy", dino);
  trex.setCollider('circle',0,0,350)
  trex.scale = 0.08
  // trex.debug=true;
  dinos = createSprite(trex.x,trex.y-30,trex.width,trex.height);
  dinos.addImage("happy",dino);
  dinos.visible = false;
  dinos.scale = 0.4
  danceTrex = createSprite(windowWidth/2,windowHeight/2.5,50,50);
  danceTrex.addAnimation("dancing",dancingTrex);
  danceTrex.scale = 0.5
  danceTrex.visible = false;
